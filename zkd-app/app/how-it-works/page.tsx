...
const BANDS = [
  ...
  { p: 'Ready', cls: 'high', t: 'Prepare harder', tag: 'still silent',
    d: 'Everything above, plus we keep re-checking those alternatives so they stay bookable, and pre-compute the policy verdict on every candidate so the decision is already made. We never reserve a seat in advance — you cannot hold two tickets, so a speculative hold would simply be cancelled.' },
