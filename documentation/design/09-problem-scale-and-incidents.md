...
**Evidence tier.** Every figure here is `external` — pulled from IATA, US DOT, DGCA, FAA, and press
...
cancellation *rate* would have missed this entirely — the crisis in §2.1 below was a planning
failure, not a weather event, and it arrived with almost no warning to the travelling public.

**2026 update — this was not a one-off.** The pattern held through this project's own build
window: US hubs saw a further wave of tech-driven disruption through summer 2026 (§2.4), and a
Northeast storm combined with a ~90-minute FAA en-route ATC system outage on 6–7 August 2026 to
produce 1,092 cancellations and 3,746 delays in a single event, concentrated at JFK, LaGuardia,
and Newark. None of this shows up as a change in the *base rate* tables above until the annual
figures are revised — which is itself the point of §2: annual rates lag the events that actually
define a member's experience by months.

---

## 2. Four recent incidents — different root causes, same member experience

Chosen to span the causal space this project has to be robust to: a **regulatory/planning**
failure (crew scheduling), a **weather-triggered cascading systems** failure, a **third-party IT**
failure with zero connection to aviation, and a **carrier's own recurring IT** failure — the same
root cause striking the same airline repeatedly within two years. All four converge on the same
thing a member actually experiences: little or no notice, and a multi-day scramble to get home.
...
- **Cost**: Over **₹24 crore (~$2.9M)** paid in passenger compensation during the crisis itself.
  DGCA granted IndiGo a temporary exemption from the new rules until 10 February 2026, capped
  airfares for the duration, and ordered a full refund clean-up.
- **Resolution, confirmed after the fact (January 2026)**: On 18 January 2026 the DGCA closed its
  inquiry and fined IndiGo **over ₹22 crore (~$2.6M)** — a one-time penalty plus a running daily
  fine for 68 days — finding the root cause was over-optimised scheduling with weak operational
  buffers, not an external shock. IndiGo separately revised pilot layover allowances upward
  (effective 1 January 2026: captains ₹3,000/hr, up from ₹2,000; first officers ₹1,500/hr, up from
  ₹1,000) as part of rebuilding the operational buffer that caused the crisis in the first place.
- **Why it matters here**: This is the exact carrier and geography this project targets. It is
  ...
  system could have keyed off days in advance. The eventual regulatory finding — confirmed six
  weeks after the crisis, not during it — underlines that even the airline's own systems didn't
  see this coming in time either.
...
### 2.4 American Airlines' recurring self-inflicted IT outage — United States, July 2026

- **Cause**: A connectivity failure inside American Airlines' own operational technology froze
  dispatch, weight-and-balance, and crew-scheduling systems across every hub simultaneously — not
  a third-party vendor and not a cyberattack. It was the **third FAA-ordered nationwide ground
  stop tied to American's own systems in under two years**: the same failure mode had already
  grounded the airline on Christmas Eve 2024 and again in June 2025.
- **Scale**: The outage on 28 July 2026 lasted roughly 48 minutes at the source, but the FAA
  ground stop and recovery affected **~1,100 flights (about 30% of that day's schedule)**, with
  **221 cancellations** and more than 40 aircraft frozen on the taxiways at DFW alone.
- **Cost**: Not yet quantified in public reporting as of this writing; the prior two occurrences
  (Dec 2024, June 2025) each drew separate FAA and press scrutiny of American's ops-tech resilience.
- **Why it matters here**: This is the sharpest available case for treating a single incident as
  informative about *recurrence*, not just severity. CrowdStrike (§2.3) argued detection must be
  cause-agnostic across *different* failure modes; this incident argues it must also assume the
  *same* carrier will produce the *same* failure mode again — a member-side system that treated
  "American had an IT outage" as resolved after the 2024 event would have been caught flat-footed
  twice more. It is also the freshest data point in this document: it happened during this
  project's own build window, seven weeks before the point-in-time this document was last updated
  (2026-08-24), and the base-rate tables in §1 have not yet been revised to reflect it.
...
- **A1 Detection lead time** (`ABSENT`). All four incidents above show why this cannot wait for a
  ...
  was a cascading systems failure, CrowdStrike's had no aviation-specific signal at all, and
  American's 2026 outage shows the same carrier can produce the identical failure mode more than
  once, so "we've seen this before" is not itself a mitigation.
- **E4 Post-recovery CSAT/NPS** (`ABSENT`). The 457-vs-16-minute delay gap in §1 is the reason this
  matters: the member experience during an incident like these four is categorically different
...
- **No claim that ZKD Concierge would have prevented any of these four incidents.** Detection
...
- [Travel And Tour World — IndiGo revises pilot allowances from January 2026 after nationwide flight disruptions](https://www.travelandtourworld.com/news/article/india-travel-update-indigo-airlines-revises-pilot-allowances-from-january-2026-after-nationwide-flight-disruptions/)
- [Zeebiz — IndiGo revises pilot allowances after flight crisis; pay hike from January 1, 2026](https://www.zeebiz.com/economy-infra/aviation/news-indigo-revises-pilot-allowances-after-flight-crisis-pay-hike-to-kick-in-from-january-1-2026-check-details-386765/amp)
...
- [Tech Times — American Airlines IT outage triggers third FAA ground stop in two years](https://www.techtimes.com/articles/321944/20260729/american-airlines-it-outage-triggers-third-faa-ground-stop-two-years.htm)
- [VisaVerge — American Airlines IT outage 2026: FAA grounds flights nationwide](https://www.visaverge.com/news/american-airlines-flights-grounded-across-us-following-major-technical-failure/)
- [Live 5 News — American Airlines temporarily grounds flights after technology issue](https://www.live5news.com/2026/07/28/american-airlines-reports-systemwide-technical-outage/)
- [NomadLawyer — Coordinated ground stops: flight disruptions reshape US travel, 2026](https://www.nomadlawyer.org/us-flight-cancellations-delays-faa-ground-stops-2026)
